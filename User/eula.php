...
<head>
	...
	<title>End User Aggrement | Bryan Christy</title>
</head>
<body>
	<div class="heading">
		<img src="../utilities/logo5.png" id="img">
		<p class="bold">Bryan Christy</p>
	</div>
	<div class="err3"><?php include '../bin/eula2.svg'; ?></div>
	<p class="text-muted">Last updated: July 19, 2021</p>
	<h1 class="center">End-User License Agreement (&quot;Agreement&quot;)</h1>
	<div class="main"><p>Please read this End-User License Agreement carefully before clicking the &quot;I Agree&quot; button, downloading or using Bryan Christy.</p>
		...
		<ul>
			<li>
				<p><strong>Agreement</strong> means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application.
			</li>
			<li>
				<p><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named Bryan Christy</p>
			</li>
			<li>
				<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Bryan Christy.</p>
			</li>
			<li>
	...
	<div class="main">
		...
		<ul>
			<li>
				<p>By writing mail to 
					<a href="mailto:bryanchirsty2016@gmail.com?subject=Quesries for EULA">Us</a>
				</p>
			</li>
			<li>
				<p>By visiting this page on our website: <a href="disclaimer" rel="external nofollow noopener" target="_blank">Disclaimer</a></p>
			</li>
		</ul>
	</div>
</body>
