...
<head>
	...
	<title>Privacy Policy | Bryan Christy</title>
<body>
	<div class="heading">
		<img src="../utilities/logo5.png" id="img">
		<p class="bold">Bryan Christy</p>
	</div>
	<div class="err3"><?php include '../bin/privacy.svg'; ?></div>
	...
	<div class="main">
		...
		<ul>
			...
			<li>
				<p><strong>Website</strong> refers to Bryan Christy, accessible from <a href="/new" rel="external nofollow noopener" target="_blank">bryanchristy.org/</a></p>
			</li>
			<li>
				<p>
	...
	<div class="main">
		...
		<ul>
			<li>
				<p>By writing main to 
					<a href="mailto:bryanchristy2016@gmail.com?subject=Queries for Privacy Policy">Us</a>
				</p>
			</li>
			<li>
